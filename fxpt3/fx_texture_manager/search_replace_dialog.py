from fxpt3.qt.pyside import QtWidgets
from fxpt3.fx_prefsaver import prefsaver, serializers

try:
    from fxpt3.fx_texture_manager.search_replace_dialog_ui6 import Ui_Dialog
except ImportError:
    from fxpt3.fx_texture_manager.search_replace_dialog_ui2 import Ui_Dialog
