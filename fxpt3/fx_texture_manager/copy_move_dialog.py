...
from fxpt3.fx_texture_manager.copy_move_info import CopyMoveInfo

try:
    from fxpt3.fx_texture_manager.copy_move_dialog_ui6 import Ui_Dialog
except ImportError:
    from fxpt3.fx_texture_manager.copy_move_dialog_ui2 import Ui_Dialog
