...
class TestQtWindow(object):
    ...
    def initPrefs(self):
        if self.qtType == TestQtWindow.QtTypePyQt:
            ...
            self.prefSaver.addControl(self.ui.uiTAB_test1, PrefSaver.UIType.PYQTTabControl, 0)
            ...
            self.prefSaver.addControl(self.ui.uiTAB_test1, PrefSaver.UIType.PYSIDETabControl, 0)
